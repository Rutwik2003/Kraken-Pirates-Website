...
const JoinCrew = () => {
  ...
  return (
    <section id="join-crew" className="py-20 bg-gray-900 relative">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-gray-900 to-transparent z-10"></div>
      <div className="absolute top-40 right-10 w-32 h-32 bg-yellow-500/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-40 left-10 w-40 h-40 bg-yellow-500/10 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 relative z-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            {activeTab === 'blox' ? (
              <>
                <h3 className="text-2xl font-bold mb-6 text-yellow-400">Blox Fruits Division</h3>
                <div className="space-y-6">
                  <div className="bg-gray-800 rounded-lg p-6 border border-yellow-600/20">
                    <h4 className="text-xl font-bold mb-4 text-white">Requirements</h4>
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-yellow-600/20 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <>
                <h3 className="text-2xl font-bold mb-6 text-yellow-400">Rell Seas Division</h3>
                <div className="space-y-6">
                  <div className="bg-gray-800 rounded-lg p-6 border border-yellow-600/20">
                    <h4 className="text-xl font-bold mb-4 text-white">Requirements</h4>
                    <ul className="space-y-3">
              ...
              <div className="space-y-3">
                {(activeTab === 'blox' ? bloxFruitsFaqs : rellSeasFaqs).map((faq, index) => (
                  <div 
                    ...
                    className={`border ${
                      expandedFaq === index 
                        ? 'border-yellow-600/30 bg-gray-700/30' 
