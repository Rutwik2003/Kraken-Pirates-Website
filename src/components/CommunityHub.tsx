...
const CommunityHub = () => {
  ...
  return (
    <section id="community" className="py-20 bg-gray-900 relative">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-full h-20 bg-gradient-to-b from-gray-900 to-transparent z-10"></div>
      <div className="absolute top-1/3 right-10 w-40 h-40 bg-yellow-500/10 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 relative z-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
          ...
          <div className="bg-gray-800 rounded-xl overflow-hidden border border-yellow-600/20">
            <div className="bg-indigo-900/30 p-6">
              <div className="flex items-center gap-3 mb-4">
                <Discord className="text-indigo-400" size={32} />
              ...
              <div className="flex flex-wrap gap-4">
                <div className="bg-gray-700/50 px-4 py-2 rounded-md text-gray-300">
                  <span className="font-bold text-indigo-400">500+</span> Members
                </div>
                <div className="bg-gray-700/50 px-4 py-2 rounded-md text-gray-300">
                  <span className="font-bold text-indigo-400">20+</span> Channels
                </div>
                <div className="bg-gray-700/50 px-4 py-2 rounded-md text-gray-300">
                  <span className="font-bold text-indigo-400">10+</span> Voice Rooms
                </div>
              </div>
            </div>
            <div className="p-6">
              ...
              <button className="w-full py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-md transition-colors flex items-center justify-center gap-2">
                <Discord size={18} />
          ...
          {/* Events Calendar */}
          <div className="bg-gray-800 rounded-xl overflow-hidden border border-yellow-600/20">
            <div className="bg-yellow-900/20 p-6">
              <div className="flex items-center gap-3 mb-4">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                {events.map((event, index) => (
                  <div key={index} className="bg-gray-700/30 rounded-lg p-4 border border-yellow-600/10">
              ...
              <button className="w-full py-3 bg-gray-700 hover:bg-gray-600 text-white font-bold rounded-md transition-colors mt-6 flex items-center justify-center gap-2 border border-yellow-600/30">
                <Calendar size={18} />
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              <Image className="text-yellow-500" size={24} />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <a href="#" className="flex flex-col items-center gap-3 p-4 bg-gray-700/30 rounded-lg hover:bg-gray-700/50 transition-colors">
              <div className="w-12 h-12 rounded-full bg-blue-600/20 flex items-center justify-center">
                <Discord className="text-blue-400" size={24} />
              </div>
